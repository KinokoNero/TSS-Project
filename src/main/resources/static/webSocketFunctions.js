...
var wsUri = getRootUri() + "/ProjektTssKucharskiIgorIo3/webSocketEndpointJson";

function getRootUri() {
    var wsUriHostPort = (location.protocol === "http:" ? "ws://" : "wss://");
    return wsUriHostPort + (document.location.hostname === "" ? "localhost" : document.location.hostname) + ":" + (document.location.port === "" ? "8080" : document.location.port);
}
